...
const ConfigTimeLimitPage = (props) => {
  ...
  const columns = configTimeLimitTableColumns({ handleModalOpen });
  return (
    <BasePage {...props}>
...
export default ConfigTimeLimitPage;
