...
import playerDepositTableColumns from "./playerDepositTableColumns.jsx";
...
const PlayerDepositPage = (props) => {
    ...
    const fetchTotal = async () => {
        ...
        const response = await dataSource.shared?.getTotalCount(tableQuery, paginateObj, "/deposit/count");
    ...
    const fetchData = async (pagingObj, newSearch) => {
        try {
            ...
            const response = await dataSource.shared?.getPlayerDepositTable(tableQuery, pagingObj);
    ...
    const handleExportClick = async (data) => {
        try {
            const response = await dataSource.shared?.exportPlayerDepositReport(data);
    ...
    const getFilterComponents = () => {
        return [
            ...
            },
            {
                ...
                queryKey: "createTime",
                startTime: {
                    placeholder: "Deposit Time Range"
                },
                endTime: {
                    placeholder: "Deposit Time Range"
                }
    ...
    const columns = playerDepositTableColumns({});
    return (
        <BasePage
            {...props}
...
export default PlayerDepositPage;
